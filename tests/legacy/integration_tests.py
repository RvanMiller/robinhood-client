...
class TestCrypto:
    ...
    def test_crypto_historicals(self):
        crypto = rh.get_crypto_historicals(
...
class TestOptions:
    ...
    totp = pyotp.TOTP(os.environ["rh_mfa_code"]).now()
    login = rh.login(
        os.environ["rh_username"], os.environ["rh_password"], mfa_code=totp
    )
    #
    ...
    def test_find_options_by_strike(self):
        ...
        info = rh.find_options_by_strike(
    ...
    def test_find_options_by_expiration_and_strike(self):
        info = rh.find_options_by_expiration_and_strike(
