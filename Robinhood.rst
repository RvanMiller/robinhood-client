...
>>> login = rh.login('joshsmith@email.com','password')
...
>>> rh.request_get(url,'regular',payload)
...
>>> rh.get_all_stocks_from_market_tag('upcoming-earnings') # get upcoming earnings
>>> rh.get_all_stocks_from_market_tag('technology') # get all tech tags
