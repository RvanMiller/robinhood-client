...
login = pk.login(os.environ['robin_username'], os.environ['robin_password'], store_session=True, mfa_code=totp)
...
order = pk.order_buy_market(stock, quantity, jsonify=False)
